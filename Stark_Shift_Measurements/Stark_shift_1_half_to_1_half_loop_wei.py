...
Number_of_amplitudes = 10 # Number of stark shift amplitudes
...
rect_amplitude_min = 0 # V; minimum amplitude of rectangular pulse train
rect_amplitude_max = 0.40 # V; maximum amplitude of rectangular pulse train
...
if command_table==1:
    ...
    ### file name ###
    file_name= 'CT_Stark_shift_1_half_to_1_half_loop_Wei'
    ### Open the file ###
...
HDAWG_filename = ('C:\\HDAWG_control\\HDAWG-Sequences\\Stark_Shift_Measurements\\Stark_shift_1_half_to_1_half_loop_wei.txt')
...
awgMod.upload_command_table(device, command_table='CT_Stark_shift_1_half_to_1_half_loop_Wei')
...
awgMod.set_value(f"/{device}/triggers/out/0/source", 0) # set up trigger, 4: Output 1 Marker 1
